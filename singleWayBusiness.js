const info = {
  pid: "", // 身分證字號
  start: 6000, // 這邊輸入啟程起始站的編號
  end: 1020, // 這邊輸入啟程終點站的編號
  date: '2023/01/29', // 這邊設定日期(記得要用“”匡起來)
  first: 421, // 這邊輸入第一志願編號（如果不需要記得寫 0）
  second: 477, // 這邊輸入第一志願編號（如果不需要記得寫 0）
  third: 0, // 這邊輸入第一志願編號（如果不需要記得寫 0）
  tickNum: 1, // 這邊輸入票數
}
